 ...
 * @returns Number
 */
export const calcularSubtotalMateriasDirectas = (recursos) => recursos
 ...
 * @returns Number
 */
export const calcularSubtotalMateriasIndirectas = (recursos) => recursos
    .filter(recurso => recurso.tipo === "materia" && !recurso.esCostoDirecto)
    .reduce(
        (anterior, actual) => anterior + calcularSubtotalRecurso(actual)
        , 0)
 ...
 * @returns Number
 */
export const calcularSubtotalManoObraDirecta = (recursos) => recursos
 ...
 * @returns Number
 */
export const calcularSubtotalManoObraIndirecta = (recursos) => recursos
    .filter(recurso => recurso.tipo === "manoObra" && !recurso.esCostoDirecto)
    .reduce(
        (anterior, actual) => anterior + calcularSubtotalRecurso(actual)
        , 0)
 ...
 * @returns Number
 */
export const calcularSubtotalOtrosIndirectos = (recursos) => recursos
...
export const calcularSubtotalIndirectoTotal = (recursos) => 
    calcularSubtotalMateriasIndirectas(recursos) + calcularSubtotalManoObraIndirecta(recursos)
...
export const calcularCostoTotal = (producto) => 
    calcularSubtotalDirectoTotal(producto) + calcularSubtotalIndirectoTotal(producto.recursos)
